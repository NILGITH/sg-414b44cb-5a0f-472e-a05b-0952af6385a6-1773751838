  ...
  public: {
    Tables: {
      content_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_submissions_menu_section_id_fkey"
          ...
          {
            foreignKeyName: "content_submissions_submenu_section_id_fkey"
            columns: ["submenu_section_id"]
            isOneToOne: false
            referencedRelation: "menu_sections"
            referencedColumns: ["id"]
          },
      ...
      menu_sections: {
        ...
        Relationships: [
          {
            foreignKeyName: "menu_sections_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "menu_sections"
            referencedColumns: ["id"]
